...
// ... (keep your existing products and categories data)
const products = [
  {
    id: 1,
  ...
  {
    id: 2,
    name: 'Samsung Galaxy S23 Ultra Clear Cover',
    category: 'cases',
    brand: 'Spigen',
    price: 35000,
    rating: 4.2,
  ...
  return (
    <section className={`py-12 ${themeStyles.bg} transition-colors duration-300 min-h-screen`}>
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Rest of your component remains the same, just replace theme with themeStyles */}
        ...
        <div className="text-center mb-10">
          ...
          <p className={`text-sm md:text-base ${theme.secondaryText} max-w-2xl mx-auto`}>
            Protect and enhance your devices with our high-quality accessories
          </p>
        </div>

        {/* Enhanced Filters */}
        <div className={`mb-8 ${theme.filterBg} p-4 rounded-lg ${theme.shadow} border ${theme.border} transition-all duration-300`}>
          <div className="flex flex-col sm:flex-row gap-4 items-center">
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 px-4 py-2 text-sm rounded-full mr-2 transition-colors duration-200 ${
                      selectedCategory === category.id
                        ...
                        : `${theme.secondaryText} ${theme.cardBg} border ${theme.border} ${theme.hoverBg}`
                    }`}
                  >
                    {category.name}
                  </button>
            ...
            <div className="w-full sm:w-48">
              <select
                className={`w-full text-sm rounded-lg ${theme.inputBg} ${theme.border} border py-2 px-3 ${theme.text} focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 outline-none transition-colors duration-200`}
                value={selectedBrand}
          ...
          <div className="mt-4">
            ...
            <div className="flex items-center space-x-4">
              <input
                ...
                max="100000"
                step="5000"
                className={`flex-1 h-2 ${theme.bg} rounded-lg appearance-none cursor-pointer accent-yellow-500`}
                value={priceRange[0]}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {filteredProducts.map((product) => (
            <div 
              key={product.id} 
              className={`group relative ${theme.cardBg} border ${theme.border} rounded-lg overflow-hidden ${theme.shadow} ${theme.hoverShadow} transition-all duration-300`}
            >
              {/* Product Image */}
              ...
              {/* Product Info */}
              <div className="p-3">
                <h3 className={`text-sm font-semibold ${theme.text} mb-1 line-clamp-2`}>
                ...
                {/* Price */}
                <p className={`text-base font-bold ${theme.text} mb-2`}>UGX {formatPrice(product.price)}</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className={`text-xs ${theme.secondaryText} ml-1`}>
                      {product.rating}
                    </span>
                  </div>
                  <span className={`text-xs font-medium ${theme.secondaryText}`}>
                    {product.brand}
                  </span>
                </div>
              </div>
